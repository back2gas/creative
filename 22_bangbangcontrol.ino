...
// Servo adjustment
#define _DUTY_MAX 2075  // Servo angle: D degree
#define _DUTY_NEU 1550  // Servo angle: 0 degree
#define _DUTY_MIN 540   // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 150 // Replace with |D - E| degree
#define _SERVO_SPEED 600 // servo speed limit (unit: degree/second)
...
return 1075 -5.7*a_value + 0.0106*pow(a_value, 2) -(6.81E-06)*pow(a_value, 3);
}
